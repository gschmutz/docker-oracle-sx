...
define(["ojs/ojcore", "jquery"], function($oj$$2$$, $$$$2$$) {
  ...
  $oj$$2$$.$Message$.$getMaxSeverity$ = function $$oj$$2$$$$Message$$$getMaxSeverity$$($messages$$) {
    ...
    $messages$$ && 0 < $messages$$.length && $$$$2$$.each($messages$$, function($i$$65$$, $message$$28$$) {
  ...
  $oj$$2$$.$ComponentMessage$ = function $$oj$$2$$$$ComponentMessage$$($summary$$2$$, $detail$$5$$, $severity$$3$$, $options$$101$$) {
    this.Init($summary$$2$$, $detail$$5$$, $severity$$3$$, $options$$101$$);
  };
  ...
  $oj$$2$$.$ComponentMessage$.prototype.Init = function $$oj$$2$$$$ComponentMessage$$$Init$($summary$$3$$, $detail$$6$$, $severity$$4$$, $options$$102$$) {
    $oj$$2$$.$ComponentMessage$.$superclass$.Init.call(this, $summary$$3$$, $detail$$6$$, $severity$$4$$);
    this.$_options$ = $$$$2$$.extend({}, $oj$$2$$.$ComponentMessage$.$_DEFAULT_OPTIONS$, $options$$102$$);
  };

...
//		$picker.remove();
    ...
    var getPickedDate = function ($obj) {
        var $picker = getParentPickerObject($obj);
        return $picker.data("pickedDate") || new Date();
    };
     ...
     * Destroy dtpicker
     */
    $.fn.dtpickerDestroy = function () {

        var inputControl = $(this);
        var dataPickerId = inputControl.data('pickerId');
        var $picker = $(PickerObjects[ dataPickerId]);

        var handler = new PickerHandler($picker, inputControl);
        handler.destroy();

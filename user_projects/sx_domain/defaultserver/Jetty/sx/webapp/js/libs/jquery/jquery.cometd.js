...
(function($)
{
    function bind($, org_cometd)
    {
        ...
        function LongPollingTransport()
        {
            ...
            {
                //var dataType = packet.url.indexOf(window.location.origin) === 0 ? 'json' : 'jsonp';
                //var jsonp = packet.url.indexOf(window.location.origin) === 0 ? false : 'jsonp';
                if (packet.url.indexOf(window.location.origin) === 0) {
                    return $.ajax({
                        url: packet.url,
    ...
    {
        define(['jquery', 'libs/org/cometd'], bind);
    }
    else
    {
        bind($, org.cometd);
